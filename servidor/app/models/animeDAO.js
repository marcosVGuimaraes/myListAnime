...
class animeDAO {
	...
	async salvarLogAtualizacaoCrawler(log){
		...
		const retorno = await this._connection.query('insert into log_crawler_atualizareps (id_anime_alterado, animes_novos, mensagem_log) VALUES ("'+ log.id_animes_alterados +'", "'+ log.animes_novos +'", "' + log.mensagem_log +'")');
...
// animeDAO.prototype.FindAll = async function(){
...
// animeDAO.prototype.FindAnime = async function(id_anime){
...
// animeDAO.prototype.FindInfoAtualizacao = async function(id_anime){
...
// animeDAO.prototype.FindStatusAnime = async function(id_anime){
...
// //Retorna os animes que estão em exibição e que não tiveram episodios cadastrados desde a ultima semana
// animeDAO.prototype.FindAnimesParaCrawler = async function(filtroData){
...
// animeDAO.prototype.verificarExisteAnime = async function(anime){
...
// animeDAO.prototype.verificarQntEpsAnime = async function(c){
...
// animeDAO.prototype.CadAnime = async function(anime){
...
// animeDAO.prototype.editAnime = async function(anime) {
...
// animeDAO.prototype.atualizarStatusAnime = async function(status, id_anime) {	
...
// animeDAO.prototype.deleteAnime = async function(id_anime){
